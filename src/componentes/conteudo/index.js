        ...
        <main className='conteudo'>
            ...
            <section className='boasvindas'>
                <div className='box-boasvindas'>
                    <motion.h1  animate={{x: -210}} className='titulo-boasvindas'>
                        Sejam bem-vindos!
                    </motion.h1>
            ...
            <section className='cards-habilidades'>
                <div className='habilidades'>
                    ...
                    <div className='box-frontend habil'>
                    ...
                    <div className='box-ferramentas habil'>
                    ...
                    <div className='box-experiencia habil'>
                        <img className='icones' src='../assets/pasta.png' alt='Experiência'/>
                        <a className='link-id' href><h3 className='titulo-habilidade-experiencia'>EXPERIÊNCIA</h3></a>
